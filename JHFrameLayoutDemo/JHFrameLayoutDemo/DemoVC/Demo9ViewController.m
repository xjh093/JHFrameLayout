...
- (void)loadView{
    ...
    [button1 setTitle:@"Click Me\n[_label jh_bottomIs:-5 fromTopOfView:_grayView updateHeight:NO];" forState:0];
    ...
    [button2 setTitle:@"Click Me\n[_label jh_bottomIs:-5 fromMiddleOfView:_grayView updateHeight:NO];" forState:0];
    ...
    [button3 setTitle:@"Click Me\n[_label jh_bottomIs:-5 fromBottomOfView:_grayView updateHeight:NO];" forState:0];
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"Demo9";
...
- (void)update1
{
    ...
    [UIView animateWithDuration:.5 animations:^{
        [_label jh_bottomIs:-5 fromTopOfView:_grayView updateHeight:NO];
    }];
...
- (void)update2
{
    ...
    [UIView animateWithDuration:.5 animations:^{
        [_label jh_bottomIs:-5 fromMiddleOfView:_grayView updateHeight:NO];
    }];
...
- (void)update3
{
    ...
    [UIView animateWithDuration:.5 animations:^{
        [_label jh_bottomIs:-5 fromBottomOfView:_grayView updateHeight:NO];
    }];
