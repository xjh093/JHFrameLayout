...
- (void)loadView{
    ...
    [button1 setTitle:@"Click Me\n[_label jh_topIs:-5 fromTopOfView:_grayView updateHeight:YES];" forState:0];
    ...
    [button2 setTitle:@"Click Me\n[_label jh_topIs:-5 fromMiddleOfView:_grayView updateHeight:YES];" forState:0];
    ...
    [button3 setTitle:@"Click Me\n[_label jh_topIs:-5 fromBottomOfView:_grayView updateHeight:YES];" forState:0];
    ...
    if (_second) {
        ...
        [button4 setTitle:@"Click Me\n[_label jh_centerYIs:-5 fromTopOfView:_grayView updateHeight:YES];" forState:0];
        ...
        [button5 setTitle:@"Click Me\n[_label jh_centerYIs:-5 fromMiddleOfView:_grayView updateHeight:YES];" forState:0];
        ...
        [button6 setTitle:@"Click Me\n[_label jh_centerYIs:-5 fromBottomOfView:_grayView updateHeight:YES];" forState:0];
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"Demo8";
...
- (void)update1
{
    ...
    [UIView animateWithDuration:.5 animations:^{
        [_label jh_topIs:-5 fromTopOfView:_grayView updateHeight:YES];
    }];
...
- (void)update2
{
    ...
    [UIView animateWithDuration:.5 animations:^{
        [_label jh_topIs:-5 fromMiddleOfView:_grayView updateHeight:YES];
    }];
...
- (void)update3
{
    ...
    [UIView animateWithDuration:.5 animations:^{
        [_label jh_topIs:-5 fromBottomOfView:_grayView updateHeight:YES];
    }];
...
{
    [UIView animateWithDuration:.5 animations:^{
        [_label jh_centerYIs:-5 fromTopOfView:_grayView updateHeight:YES];
    }];
}
...
{
    [UIView animateWithDuration:.5 animations:^{
        [_label jh_centerYIs:-5 fromMiddleOfView:_grayView updateHeight:YES];
    }];
}
...
{
    [UIView animateWithDuration:.5 animations:^{
        [_label jh_centerYIs:-5 fromBottomOfView:_grayView updateHeight:YES];
    }];
}
