...
- (void)loadView{
    ...
    [button1 setTitle:@"Click Me\n[_label jh_leftIs:-5 fromLeftOfView:_grayView updateWidth:YES];" forState:0];
    ...
    [button2 setTitle:@"Click Me\n[_label jh_leftIs:-5 fromMiddleOfView:_grayView updateWidth:YES];" forState:0];
    ...
    [button3 setTitle:@"Click Me\n[_label jh_leftIs:-5 fromRightOfView:_grayView updateWidth:YES];" forState:0];
...
- (void)update1
{
    ...
    [UIView animateWithDuration:.5 animations:^{
        [_label jh_leftIs:-5 fromLeftOfView:_grayView updateWidth:YES];
    }];
...
- (void)update2
{
    ...
    [UIView animateWithDuration:.5 animations:^{
        [_label jh_leftIs:-5 fromMiddleOfView:_grayView updateWidth:YES];
    }];
...
- (void)update3
{
    ...
    [UIView animateWithDuration:.5 animations:^{
        [_label jh_leftIs:-5 fromRightOfView:_grayView updateWidth:YES];
    }];
